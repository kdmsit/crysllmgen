...
class GenEval(object):
    ...
    def get_validity(self):
        ...
        return {'comp_valid': round(comp_valid*100,4),
                'struct_valid': round(struct_valid*100,4),
                'valid': round(valid*100,4)}
    ...
    def get_density_wdist(self):
        ...
        return {'wdist_density': round(wdist_density,4)}
    ...
    def get_num_elem_wdist(self):
        ...
        return {'wdist_num_elems': round(wdist_num_elems,4)}
...
def get_crystal_array_list(file_path, batch_idx=0):
    ...
    # print("Data shape: ",data['frac_coords'].shape)
    if batch_idx == -1:
        ...
        if len(data['frac_coords'].size()) ==2:
            ...
            # print("here else..")
            # print(batch_idx)
            # print('frac_coords',data['frac_coords'][batch_idx])
            # print('atom_types',data['atom_types'][batch_idx])
            # print('num_atoms',data['num_atoms'][batch_idx])
...
def main(args):
    ...
    if 'gen' in args.tasks:
        ...
        print("Length:",len(crys_array_list))
